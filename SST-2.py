...
data_path = 'GLUE/SST-2/train.tsv'
df = pd.read_csv(data_path, sep='\t')

df.columns = ['sen','label'] #for SST-2

test_path = 'GLUE/SST-2/dev.tsv'
df_test = pd.read_csv(test_path, sep='\t')

df_test.columns = ['sen','label'] #for SST-2
...
def plotImage(G_losses, name):
    ...
    plt.ylabel("Accuracy")
    plt.savefig('./result/SST/'+name+'.png')
